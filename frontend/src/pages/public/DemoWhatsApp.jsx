    ...
    <div className="min-h-screen bg-dark-950">
      ...
      <div className="bg-gradient-to-br from-brand-600 to-brand-800 text-white">
        <div className="max-w-4xl mx-auto px-6 py-8">
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="text-xl font-bold">Reven<span className="text-brand-600">dr</span></span>
          </div>
      ...
      <div className="max-w-4xl mx-auto px-6 py-8">
        ...
        <div className="text-center mt-8 text-dark-500 text-sm">
          <p>Powered by <span className="text-brand-400 font-medium">Reven<span className="text-brand-600">dr</span></span></p>
        </div>
      </div>
    </div>
  )
