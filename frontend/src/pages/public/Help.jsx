...
const faqEs = [
  ...
  },
  {
    ...
    a: 'Configurá tu cuenta de MercadoPago en Settings → API Keys. Los clientes pagan con tarjeta de crédito directamente desde la propuesta.',
  },
  {
...
const faqEn = [
  ...
  },
  {
    ...
    a: 'Set up your MercadoPago account in Settings → API Keys. Clients pay with credit card directly from the proposal.',
  },
  {
      ...
      <nav className="border-b border-dark-800 bg-dark-950/80 backdrop-blur-sm sticky top-0 z-50">
        <div className="max-w-4xl mx-auto px-6 py-4 flex items-center justify-between">
          <Link to="/" className="flex items-center gap-3">
            ...
            <span className="text-xl font-bold text-dark-50">Revendr<span className="text-brand-400">dr</span></span>
          </Link>
