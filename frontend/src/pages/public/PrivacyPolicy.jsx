        ...
        <div className="prose prose-invert max-w-none space-y-8 text-dark-300 leading-relaxed">
          ...
          <section>
            ...
            <ul className="list-disc list-inside mt-2 space-y-1">
              ...
              <li>Información de pago (procesada por MercadoPago, no almacenada en nuestros servidores)</li>
            </ul>
          ...
          <section>
            ...
            <ul className="list-disc list-inside mt-2 space-y-1">
              ...
              <li><strong>MercadoPago:</strong> Procesamiento de pagos (datos de tarjeta no almacenados por nosotros)</li>
