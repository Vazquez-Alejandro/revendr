      ...
      <nav className="border-b border-dark-800 bg-dark-950/80 backdrop-blur-sm sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 md:px-6 py-3 md:py-4 flex items-center justify-between">
          <Link to="/" className="flex items-center gap-2 md:gap-3">
            ...
            <span className="text-xl md:text-2xl font-bold text-dark-50">Revendr<span className="text-brand-400">dr</span></span>
          </Link>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-3">
              ...
              <span className="font-bold text-dark-100">Revendr<span className="text-brand-400">dr</span></span>
            </div>
