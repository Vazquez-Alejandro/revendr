...
const plans = [
  {
    ...
    features: [
      '100 leads/mes',
      '1 rubro activo',
      '50 propuestas generadas',
      '900 mensajes WhatsApp',
      'Soporte por email',
    ],
    icon: Zap,
    popular: false,
  },
  {
    ...
    features: [
      '1,000 leads/mes',
      '3 rubros activos',
      '500 propuestas generadas',
      '3,000 mensajes WhatsApp',
      'A/B Testing',
      'Soporte prioritario',
    ],
    icon: Building2,
      ...
      <nav className="border-b border-dark-800 bg-dark-950/80 backdrop-blur-sm sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 md:px-6 py-3 md:py-4 flex items-center justify-between">
          <Link to="/" className="flex items-center gap-2 md:gap-3">
            ...
            <span className="text-lg md:text-xl font-bold text-dark-50">Reven<span className="text-brand-600">dr</span></span>
          </Link>
