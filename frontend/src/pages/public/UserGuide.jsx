...
const stepsEs = [
  {
    ...
    description: 'Andá a Productos → Nuevo Producto. Poné el nombre de tu empresa, la URL de tu demo, elegí el rubro y configurá la landing personalizada.',
    details: [
      'Nombre: el nombre de tu empresa o servicio',
      'URL Demo: link a tu app o landing principal',
      'Rubro: a quién le vendés (ej: agencias de marketing)',
      'Landing: título, descripción, color y botón CTA',
    ],
    tip: 'El color de la landing se usa en la demo personalizada que ven tus prospectos.',
  },
  {
    icon: Target,
  ...
  {
    icon: Zap,
    title: 'Paso 4: Generá demos',
    path: '/dashboard/campanias',
    description: 'Una vez que tenés leads, generá las demos personalizadas. Cada negocio recibe una landing con su nombre y datos.',
    details: [
      'Click en "Generar Demos" dentro de la campaña',
    ...
    tip: 'Las demos se generan en batch. Si tenés 100 leads, las genera todas juntas.',
  },
  {
    icon: MessageSquare,
    title: 'Paso 5: Enviá mensajes',
    path: '/dashboard/campanias',
    description: 'Mandá emails o WhatsApp a los leads con el link a su demo personalizada.',
    details: [
  ...
  },
  {
    ...
    description: 'Andá a Leads para ver quién abrió tu mensaje, quién vio la demo y quién está interesado.',
    details: [
...
const stepsEn = [
  {
    ...
    path: '/dashboard/productos',
    description: 'Go to Products → New Product. Enter your company name, demo URL, select the niche and configure the personalized landing.',
    details: [
      'Name: your company or service name',
      'Demo URL: link to your main app or landing',
      'Niche: who you sell to (e.g., marketing agencies)',
      'Landing: title, description, color and CTA button',
    ],
    tip: 'The landing color is used in the personalized demo your prospects see.',
  },
  {
    icon: Target,
  ...
  {
    icon: Zap,
    title: 'Step 4: Generate demos',
    path: '/dashboard/campanias',
    description: 'Once you have leads, generate personalized demos. Each business gets a landing with their name and data.',
    details: [
      'Click "Generate Demos" inside the campaign',
    ...
    tip: 'Demos are generated in batch. If you have 100 leads, they all generate together.',
  },
  {
    icon: MessageSquare,
    title: 'Step 5: Send messages',
    path: '/dashboard/campanias',
    description: 'Send emails or WhatsApp to leads with the link to their personalized demo.',
    details: [
  ...
  },
  {
    ...
    path: '/dashboard/leads',
    description: 'Go to Leads to see who opened your message, who viewed the demo and who is interested.',
    details: [
